...
export default function DemoScreenRevampedFixed({ autoStart = false }: DemoScreenProps) {
  ...
  const steps = [
    { delay: 0, duration: 6500, name: "intro" },
    { delay: 6500, duration: 7500, name: "swap" },
    { delay: 14000, duration: 12000, name: "lottery" },
    { delay: 26000, duration: 8000, name: "fees" },
    { delay: 34000, duration: 12000, name: "breakdown" },
    { delay: 46000, duration: 15000, name: "mechanics" },
    { delay: 61000, duration: 7000, name: "vrf" },
    { delay: 68000, duration: 8000, name: "layerzero" },
    { delay: 76000, duration: 8000, name: "complete" },
  ];
          ...
          try {
            ...
            const fadeInInterval = setInterval(() => {
              if (audioRef.current && audioRef.current.volume < 0.7) {
                audioRef.current.volume = Math.min(0.7, audioRef.current.volume + 0.05);
              } else {
      ...
      {isPlaying && (
        <div className="fixed inset-0 z-10 flex items-center justify-center">
          <AnimatePresence mode="wait">
            {/* Introduction */}
            {currentStep === 0 && (
              <motion.div key="intro" {...fadeIn} className="text-center max-w-4xl mx-auto p-8">
                <motion.h1
                  {...slideUp}
            ...
            {currentStep === 8 && (
              <motion.div key="complete" {...fadeIn} className="text-center max-w-6xl mx-auto p-8">
                ...
                >
                  revolutionary defi gaming
                </motion.h2>
                <motion.p
                  {...slideUp}
                  transition={{ delay: 0.5, duration: 1 }}
                  className="text-2xl text-slate-300 font-light mb-12"
                >
                  join the sonic dragon ecosystem today
                </motion.p>
                <motion.div
                  {...slideUp}
                  transition={{ delay: 1, duration: 1 }}
                ...
                >
                  <motion.button
                    className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-medium py-4 px-12 rounded-xl mr-6 shadow-lg shadow-cyan-500/25"
                  ...
                  <motion.button
                    className="border border-slate-600 text-slate-300 font-medium py-4 px-12 rounded-xl shadow-lg"
